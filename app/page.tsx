      ...
      <header className="flex items-center justify-between px-6 py-4 border-b border-border bg-surface">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted">Event planning insights from 58 blog posts, interviews, lectures, and articles</p>
          </div>
        </div>
      </header>
        ...
        {isEmpty ? (
          <div className="flex flex-col items-center justify-center h-full px-6 py-12">
            ...
            <p className="text-muted text-center max-w-md mb-8">
              Drawing from decades of event planning experience across 58 blog posts, interviews, lectures, and press articles.
